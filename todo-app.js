...
var todoModel = {
    ...
    clearCompleteTodo: function() {
         for(var i = 0; i < this.todos.length; i++) { 
             if(this.todos[i].complete) { this.todos.splice(i, 1); }       
             }
        }
    ...
    displayTodos: function() {
        ...
        for(var i = 0; i < todoModel.todos.length; i++) {
            if((todoModel.showMode == 1) ||
              ...
              if(todoModel.todos[i].complete == false) { this.activeCount++; }
              if(todoModel.todos[i].complete) { this.completeExist = true; }
